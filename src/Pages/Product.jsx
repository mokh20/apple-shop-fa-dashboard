    ...
    <section className="grid justify-center m-4">
      <div className="border-b-2 border-b-gray-200 md:flex md:border-none lg:gap-12">
        <div className="grid content-around">
          ...
          <div className="hidden md:grid md:items-end gap-4">
            <span className="flex items-center gap-2">
              <i className="fi fi-rs-truck-moving"></i>
              <p>Delivery : In Stock</p>
            </span>
            <button
              className="rounded-md bg-blue-600 text-white px-16 py-2 max-w-[350px]"
      ...
      <div className="grid my-4 md:hidden">
        <i className="fi fi-rs-truck-moving"></i>
        <p>Delivery : In Stock</p>
        <button
          className="rounded-md bg-blue-600 text-white px-16 py-2 my-2"
          onClick={(e) => addToCart(e)}
        >
          Add to Bag
        </button>
